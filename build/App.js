...
},{"metal":56,"metal-dom":19}],2:[function(require,module,exports){
'use strict';
...
},{"./ComponentDataManager":3,"./ComponentRenderer":5,"./events/events":7,"./sync/sync":8,"metal":56,"metal-dom":19,"metal-events":31}],3:[function(require,module,exports){
'use strict';
...
},{"metal":56,"metal-state":49}],4:[function(require,module,exports){
'use strict';
...
},{"metal":56}],5:[function(require,module,exports){
'use strict';
...
},{"../Component":2,"../ComponentDataManager":3,"../ComponentRegistry":4,"../ComponentRenderer":5,"../events/events":7}],7:[function(require,module,exports){
'use strict';
...
},{"metal":56}],8:[function(require,module,exports){
'use strict';
...
},{"metal":56}],9:[function(require,module,exports){
'use strict';

Object.defineProperty(exports, "__esModule", {
	value: true
});
exports.DELAY_TIME = undefined;
...
var DELAY_TIME = exports.DELAY_TIME = 10;
...
var TransitionChild = function (_Component) {
   ...
   */
		...
		key: 'delayActive_',
		value: function delayActive_(className, node) {
			setTimeout(function () {
				node.classList.add(className);

				_metalAnim2.default.emulateTransitionEnd(node);
			}, DELAY_TIME);
		}
   ...
   */
		...
		key: 'transition_',
		value: function transition_(type, finishCallback) {
			var node = this.element;
			if (!node) {
				return;
			}

			var className = this.props.name + '-' + type;
			...
			_metalDom2.default.once(node, 'transitionend', callback);
...
TransitionChild.PROPS = {
  ...
  * @type {string}
  */
	name: _metalJsx.Config.string()
};

exports.default = TransitionChild;
},{"metal-anim":1,"metal-dom":19,"metal-jsx":12}],10:[function(require,module,exports){
'use strict';
 ...
 */
var TransitionWrapper = function (_Component) {
	_inherits(TransitionWrapper, _Component);

	function TransitionWrapper() {
		_classCallCheck(this, TransitionWrapper);

		return _possibleConstructorReturn(this, (TransitionWrapper.__proto__ || Object.getPrototypeOf(TransitionWrapper)).apply(this, arguments));
	}
   ...
   */
		value: function created() {
			this.state.childrenMap_ = (0, _utils.getChildrenMap)(this.props.children);
		...
		value: function attached() {
			...
			this.props.children.forEach(function (child) {
				if (child && child.props) {
					...
					if (key && _this2.components[key]) {
						_this2.components[key].appear();
					}
				}
			});
		}
   ...
   */
		...
		key: 'finishLeave_',
		value: function finishLeave_(key) {
			var newChildrenMap = this.state.childrenMap_;
   ...
   */
		...
		key: 'handleChildrenEnter_',
		value: function handleChildrenEnter_(newChildren, prevKeyMap) {
			var _this3 = this;
			...
			newChildren.forEach(function (child) {
				if (child && child.props) {
					...
					if (key && !prevKeyMap.has(key) && _this3.components[key]) {
						_this3.components[key].enter();
					}
				}
			});
		}
   ...
   */
		...
		key: 'handleChildrenLeave_',
		value: function handleChildrenLeave_(prevChildren, newKeyMap) {
			var _this4 = this;
			...
			prevChildren.forEach(function (child) {
				if (child && child.props) {
					...
					if (key && !newKeyMap.has(key) && _this4.components[key]) {
						_this4.components[key].leave(_this4.finishLeave_.bind(_this4, key));
					}
				}
			});
		}
   ...
   */
		...
		key: 'syncChildren',
		value: function syncChildren(newChildren) {
			var _this5 = this;

			var prevChildren = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];

			var newKeyMap = (0, _utils.getChildrenMap)(newChildren);
			var prevKeyMap = (0, _utils.getChildrenMap)(prevChildren);

			this.setState({
				childrenMap_: (0, _utils.mergeChildrenMap)(newKeyMap, prevKeyMap)
			}, function () {
				_this5.handleChildrenEnter_(newChildren, prevKeyMap);
				_this5.handleChildrenLeave_(prevChildren, newKeyMap);
			});
		}
   ...
   */
		...
		value: function render() {
			...
			var childrenMap_ = this.state.childrenMap_;


			childrenMap_.forEach(function (child) {
				if (child) {
					children.push(child);
				}
			});
			...
			iDOMHelpers.renderArbitrary(!!children.length && children.map(function (child) {
				return iDOMHelpers.jsxWrapper(function (_this6$props$name, _child$props$key, _child) {
					IncrementalDOM.elementOpen(_TransitionChild2.default, null, null, 'name', _this6$props$name, 'ref', _child$props$key);
					iDOMHelpers.renderArbitrary(_child);
					return IncrementalDOM.elementClose(_TransitionChild2.default);
				}, [_this6.props.name, child.props.key, child]);
			}));
...
TransitionWrapper.STATE = {
  ...
  * @protected
  */
	childrenMap_: _metalJsx.Config.value({})
};

exports.default = TransitionWrapper;
},{"./TransitionChild":9,"./utils":11,"metal-jsx":12}],11:[function(require,module,exports){
'use strict';
...
},{"./JSXDataManager":13,"./JSXRenderer":14,"./iDOMHelpers":15,"metal-component":6,"metal-incremental-dom":32,"metal-state":49}],13:[function(require,module,exports){
'use strict';
...
},{"metal":56,"metal-component":6,"metal-state":49}],14:[function(require,module,exports){
'use strict';
...
},{"metal":56,"metal-incremental-dom":32}],15:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./JSXRenderer":14,"metal-incremental-dom":32}],16:[function(require,module,exports){
'use strict';
...
},{"./domData":21,"metal":56,"metal-events":31}],17:[function(require,module,exports){
'use strict';
...
},{"./dom":20,"metal-events":31}],18:[function(require,module,exports){
'use strict';
...
},{"metal-events":31}],19:[function(require,module,exports){
'use strict';
...
},{"../DomEventEmitterProxy":17,"../DomEventHandle":18,"../dom":20,"../domData":21,"../events":23,"../features":24,"../globalEval":25,"../globalEvalStyles":26}],20:[function(require,module,exports){
'use strict';
...
exports.default = dom;
exports.dom = dom;
},{"./domNamed":22}],21:[function(require,module,exports){
'use strict';
...
},{"./DomDelegatedEventHandle":16,"./DomEventHandle":18,"./domData":21,"metal":56}],23:[function(require,module,exports){
'use strict';
...
},{"./dom":20,"./features":24}],24:[function(require,module,exports){
'use strict';
...
},{"./dom":20,"metal":56}],25:[function(require,module,exports){
'use strict';
...
},{"./dom":20,"metal":56}],26:[function(require,module,exports){
'use strict';
...
},{"./dom":20,"metal":56}],27:[function(require,module,exports){
'use strict';
...
},{"./EventHandle":29,"metal":56}],28:[function(require,module,exports){
'use strict';
...
},{"metal":56}],29:[function(require,module,exports){
'use strict';
...
},{"metal":56}],30:[function(require,module,exports){
'use strict';
...
},{"metal":56}],31:[function(require,module,exports){
'use strict';
...
},{"./EventEmitter":27,"./EventEmitterProxy":28,"./EventHandle":29,"./EventHandler":30}],32:[function(require,module,exports){
'use strict';
...
},{"./changes":34,"./children/children":35,"./data":37,"./incremental-dom":38,"./render/patch":41,"./render/render":42,"metal-component":6}],33:[function(require,module,exports){
'use strict';
...
},{"./data":37}],35:[function(require,module,exports){
'use strict';
...
},{"../callArgs":33,"../intercept":39,"metal":56}],36:[function(require,module,exports){
'use strict';
...
},{"./incremental-dom":38}],40:[function(require,module,exports){
'use strict';
...
},{"../intercept":39,"metal":56,"metal-component":6,"metal-dom":19}],41:[function(require,module,exports){
'use strict';
...
},{"../data":37,"./render":42,"metal-dom":19}],42:[function(require,module,exports){
'use strict';
...
},{"../callArgs":33,"../changes":34,"../children/children":35,"../cleanup/unused":36,"../data":37,"../intercept":39,"./attributes":40,"metal":56,"metal-component":6,"metal-dom":19}],43:[function(require,module,exports){
arguments[4][12][0].apply(exports,arguments)
},{"./JSXDataManager":44,"./JSXRenderer":45,"./iDOMHelpers":46,"dup":12,"metal-component":6,"metal-incremental-dom":32,"metal-state":49}],44:[function(require,module,exports){
arguments[4][13][0].apply(exports,arguments)
},{"dup":13,"metal":56,"metal-component":6,"metal-state":49}],45:[function(require,module,exports){
arguments[4][14][0].apply(exports,arguments)
},{"dup":14,"metal":56,"metal-incremental-dom":32}],46:[function(require,module,exports){
arguments[4][15][0].apply(exports,arguments)
},{"./JSXRenderer":45,"dup":15,"metal-incremental-dom":32}],47:[function(require,module,exports){
'use strict';
...
},{"./validators":50,"metal":56}],48:[function(require,module,exports){
'use strict';
...
},{"metal":56,"metal-events":31}],49:[function(require,module,exports){
'use strict';
...
},{"../Config":47,"../State":48,"../validators":50}],50:[function(require,module,exports){
'use strict';
...
},{"metal":56}],51:[function(require,module,exports){
'use strict';
...
},{"../core":53}],52:[function(require,module,exports){
/*!
...
exports.core = core;
},{"./coreNamed":54}],54:[function(require,module,exports){
'use strict';
...
},{"./array/array":51,"./async/async":52,"./core":53,"./disposable/Disposable":55,"./object/object":57,"./string/string":58}],57:[function(require,module,exports){
'use strict';
...
var _metalCssTransitions = require('metal-css-transitions');

var _metalCssTransitions2 = _interopRequireDefault(_metalCssTransitions);
...
var App = function (_Component) {
	...
	_createClass(App, [{
		...
		key: 'getChildren_',
		value: function getChildren_() {
			var index = this.state.index;


			return [iDOMHelpers.jsxWrapper(function (_index, _index2) {
				IncrementalDOM.elementOpen('div', _index, ['class', 'child', 'key', _index]);
				IncrementalDOM.text('child ');
				iDOMHelpers.renderArbitrary(_index2);
				return IncrementalDOM.elementClose('div');
			}, [index, index]), iDOMHelpers.jsxWrapper(function (_ref, _ref2) {
				IncrementalDOM.elementOpen('div', _ref, ['class', 'child', 'key', _ref]);
				IncrementalDOM.text('child ');
		...
		value: function render() {
			IncrementalDOM.elementOpen('span');
			IncrementalDOM.elementOpen('button', null, null, 'onClick', this.onClick_);
			IncrementalDOM.text('Click Me');
			IncrementalDOM.elementClose('button');
			IncrementalDOM.elementOpen(_metalCssTransitions2.default, null, null, 'name', 'test');
			iDOMHelpers.renderArbitrary(this.getChildren_());
			IncrementalDOM.elementClose(_metalCssTransitions2.default);
			return IncrementalDOM.elementClose('span');
		}
	}]);
...
App.STATE = {
	index: _metalJsx.Config.value(1)
};

window.ExampleApp = App;

},{"metal-css-transitions":10,"metal-jsx":43}]},{},[59]);
